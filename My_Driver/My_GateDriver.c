...
//	DRV8301_WriteControl_Register2(CONTROL2_OCTW_BOTH,CONTROL2_GAIN_40,CONTROL2_CAL_CH1,CONTROL2_CAL_CH2,CONTROL2_OCTOFF_CBC);
//	DRV8301_WriteControl_Register2(CONTROL2_OCTW_BOTH,CONTROL2_GAIN_40,CONTROL2_CAL1_NORMAL,CONTROL2_CAL2_NORMAL,CONTROL2_OCTOFF_CBC);
//	DRV8301_ID = DRV8301_Read_DeviceID();
//	if(DRV8301_Diagnose() == 0){ 
//	}

void DRV8301_CAL(void){
	DRV8301_Disable();
	System_Delay(1);
	DRV8301_Enable();
	System_Delay(20);  //Important   //drv8323 failed reason
